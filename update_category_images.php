<?php
require __DIR__ . '/public_html/core/vendor/autoload.php';
$app = require_once __DIR__ . '/public_html/core/bootstrap/app.php';
...
$dir = __DIR__ . '/public_html/assets/images/category';
if (!file_exists($dir)) {
    mkdir($dir, 0755, true);
}
