...
use App\Http\Middleware\InfluencerCheck;
...
use App\Http\Middleware\RedirectIfNotInfluencer;
...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        using: function () {
            Route::namespace('App\Http\Controllers')->middleware([VugiChugi::mdNm()])->group(function () {
                ...
                Route::middleware(['web', 'maintenance'])->prefix('brand')->group(base_path('routes/user.php'));
                Route::middleware(['web', 'maintenance'])->prefix('influencer')->group(base_path('routes/influencer.php'));
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'influencer_kyc'                   => InfluencerKycMiddleware::class,

            'influencer'                       => RedirectIfNotInfluencer::class,
