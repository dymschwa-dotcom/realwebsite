...
Route::middleware('admin')->group(function () {
    ...
    // Users Manager
    Route::controller('ManageUsersController')->name('users.')->prefix('brands')->group(function () {
    ...
    // Influencer Manager
    Route::controller('ManageInfluencerController')->name('influencer.')->prefix('influencers')->group(function () {
        Route::get('/', 'allUsers')->name('all');
        Route::get('active', 'activeUsers')->name('active');
        Route::get('banned', 'bannedUsers')->name('banned');
        Route::get('email-verified', 'emailVerifiedUsers')->name('email.verified');
    ...
    // Report
    Route::controller('InfluencerReportController')->prefix('influencer/report')->name('influencer.report.')->group(function () {
        Route::get('transaction/{user_id?}', 'transaction')->name('transaction');
        Route::get('login/history', 'loginHistory')->name('login.history');
        Route::get('login/ipHistory/{ip}', 'loginIpHistory')->name('login.ipHistory');
        Route::get('notification/history', 'notificationHistory')->name('notification.history');
    ...
    Route::controller('SupportTicketController')->prefix('influencer/ticket')->name('influencers.ticket.')->group(function () {
        Route::get('/', 'influencerTickets')->name('index');
        Route::get('pending', 'influencerPendingTicket')->name('pending');
        Route::get('closed', 'influencerClosedTicket')->name('closed');
        Route::get('answered', 'influencerAnsweredTicket')->name('answered');
        Route::get('view/{id}', 'ticketReply')->name('view');
    });
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::get('social/credentials', 'socialiteCredentials')->name('setting.socialite.credentials');
    ...
    Route::controller('ParticipantController')->name('participant')->name('participant.')->group(function () {
        Route::get('all', 'all')->name('campaign.all');
        Route::get('pending', 'pending')->name('campaign.pending');
        Route::get('accepted', 'accepted')->name('campaign.accepted');
        Route::get('delivered', 'delivered')->name('campaign.delivered');
        Route::get('reported', 'reported')->name('campaign.reported');
        Route::get('canceled', 'canceled')->name('campaign.canceled');
        Route::get('rejected', 'rejected')->name('campaign.rejected');
        Route::get('completed', 'completed')->name('campaign.completed');
    });

    // Platform
    Route::controller('PlatformController')->prefix('platform')->name('platform.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('status/{id}', 'status')->name('status');
    });

    Route::controller('ManageCampaignController')->prefix('campaign')->name('campaign.')->group(function () {
        Route::get('index', 'index')->name('index');
