                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-onstyle="-success"
                                           ...
                                           @if ($influencer->is_gst_registered) checked @endif>
                                </div>
                            </div>

                            <div class="col-md-12 gst-number-wrapper" @if(!$influencer->is_gst_registered) style="display: none;" @endif>
                                <div class="form-group">
                                    <label>@lang('GST Number')</label>
                                    <input class="form-control" type="text" name="gst_number" value="{{ $influencer->gst_number }}">
                                </div>
                            </div>
