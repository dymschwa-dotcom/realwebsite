...
@section('panel')
    ...
    <div class="row gy-4 mt-1">
        ...
        <div class="col-xxl-3 col-sm-6">
            ...
            <x-widget
                style="6"
                link="{{route('admin.influencer.all')}}"
                icon="las la-users"
                title="Total Influencers"
                value="{{$widget['total_influencer']}}"
                bg="primary"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="6"
                link="{{route('admin.influencer.active')}}"
                icon="las la-user-check"
                title="Active Influencers"
                value="{{$widget['verified_influencer']}}"
                bg="success"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="6"
                link="{{route('admin.influencer.email.unverified')}}"
                icon="lar la-envelope"
                title="Email Unverified Influencers"
                value="{{$widget['email_unverified_influencer']}}"
                bg="danger"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="6"
                link="{{route('admin.influencer.mobile.unverified')}}"
                icon="las la-comment-slash"
                title="Mobile Unverified Influencers"
                value="{{$widget['mobile_unverified_influencer']}}"
                bg="warning"
            />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-1">
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ getAmount($widget['total_campaign']) }}" title="Total Campaign" style="2"
                icon_style="true" link="{{ route('admin.campaign.index') }}" icon="lab la-wpforms" color="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ getAmount($widget['pending_campaign']) }}" title="Pending Campaign" style="2"
                icon_style="true" link="{{ route('admin.campaign.pending') }}" icon="las la-hourglass-half"
                color="warning" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ getAmount($widget['approved_campaign']) }}" title="Approved Campaign" style="2"
                icon_style="true" link="{{ route('admin.campaign.approved') }}" icon="las la-check-circle"
                color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ getAmount($widget['rejected_campaign']) }}" title="Rejected Campaign" style="2"
                icon_style="true" link="{{ route('admin.campaign.rejected') }}" icon="las la-times-circle" color="danger" />
        </div>
    </div>
