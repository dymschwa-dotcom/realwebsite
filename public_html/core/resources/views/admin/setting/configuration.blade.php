                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li
                                ...
                                <div>
                                    <p class="fw-bold mb-0">@lang('Brand Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, brand can\'t register on this system')</small>
                                    </p>
                                </div>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Influencer Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, influencer can\'t register on this system')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        name="influencer_registration" @if (gs('influencer_registration')) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Brand KYC Verification')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span>
                                            @lang('module, brands must have to submit') <a
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span>
                                            @lang('module, influencers must have to submit') <a
                                                href="{{ route('admin.influencer.kyc.setting') }}">@lang('the required data')</a>.
                                            @lang('Otherwise, any money out transaction will be prevented by this system.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="influencer_kv"
                                        @if (gs('influencer_kv')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Campaign Auto Approval')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the campaign requests automatic approval in your system')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')"
                                        name="campaign_approve" @if (gs('campaign_approve')) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Brand Register Commission')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the brand will receive a registration bonus when he registers on your site')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')"
                                        name="brand_register_commission"
                                        @if (gs('brand_register_commission')) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Influencer Register Commission')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the influencer will receive a registration bonus when he registers on your site')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')"
                                        name="influencer_register_commission"
                                        @if (gs('influencer_register_commission')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Influencer Withdrawal Commission')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the referred influencer will receive a withdrawal commission when the influencer withdrawan on your site.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')"
                                        name="influencer_withdrawal_commission"
                                        @if (gs('influencer_withdrawal_commission')) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Campaign Approval Charge')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the campaign approval charge will be deducted from the brand account')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')"
                                        name="campaign_charge" @if (gs('campaign_charge')) checked @endif>
                                </div>
                            </li>
