                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                                <span class="small">
                                                    <a href="{{ route('admin.influencer.detail', $log->influencer_id) }}"><span>@</span>{{ $log->influencer->username }}</a>
                                                </span>
                                            @else
...
@push('breadcrumb-plugins')
    @if(@$user)
        <a href="{{ route('admin.influencer.notification.single',$user->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
