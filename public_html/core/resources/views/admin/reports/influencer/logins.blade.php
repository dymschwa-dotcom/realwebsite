                                ...
                                @forelse($loginLogs as $log)
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <span class="small"> <a
                                                    href="{{ route('admin.influencer.detail', $log->influencer_id) }}"><span>@</span>{{ @$log->influencer->username }}</a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="{{ route('admin.influencer.report.login.ipHistory', [$log->user_ip]) }}">{{ $log->user_ip }}</a>
                                            </span>
                                        </td>
...
@push('breadcrumb-plugins')
    @if (request()->routeIs('admin.influencer.report.login.history'))
