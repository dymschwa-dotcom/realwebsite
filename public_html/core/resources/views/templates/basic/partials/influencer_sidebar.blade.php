<div class="sidebar-menu">
    ...
    <div class="sidebar-menu__profile text-center">
        <div class="thumb">
            ...
            <img src="{{ getImage(getFilePath('influencer') . '/thumb_' . auth()->guard('influencer')->user()->image, getFileSize('influencer')) }}" alt="profile">
        </div>
        <div class="sidebar-menu__profile-content d-flex justify-content-between gap-2">
            <div class="left text-start">
                <h5 class="title">
                    {{ __(auth()->guard('influencer')->user()->fullname) }}
                </h5>
            ...
            <div class="right">
                <div class="dropdown profile-action">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="">
                        ...
                        <li><a class="dropdown-item" href="{{ route('influencer.twofactor') }}">@lang('2FA Verify')</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <ul class="sidebar-menu-list">
        ...
        <li class="sidebar-menu-list__item {{ menuActive('influencer.reviews.list') }}">
            <a class="sidebar-menu-list__link" href="{{ route('influencer.reviews.list') }}">
                <span class="icon">
        ...
        <li class="sidebar-menu-list__item {{ menuActive('influencer.ticket*') }}">
            <a class="sidebar-menu-list__link" href="{{ route('influencer.ticket.index') }}">
                <span class="icon">
        ...
        <li class="sidebar-menu-list__item {{ menuActive('influencer.transactions') }}">
            <a class="sidebar-menu-list__link" href="{{ route('influencer.transactions') }}">
                <span class="icon">
