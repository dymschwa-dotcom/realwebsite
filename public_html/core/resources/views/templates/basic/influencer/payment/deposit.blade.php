...
@section('content')
    <div class="brand-dashboard-header d-flex align-items-center justify-content-between gap-3 mb-4  flex-wrap">
        <div class="brand-dashboard-header__left">
            <h5>@lang('Add your money')</h5>
            <p class="fs-14">@lang('Select payment option to add balance to your funds.')</p>
        </div>
        <div class="brand-dashboard-header__right">
            <a href="{{ route('user.deposit.history') }}" class="btn btn--base" type="button">@lang('Add money history') <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
