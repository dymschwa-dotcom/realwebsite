                        ...
                        <div class="account-form">
                            <div class="account-heading">
                                ...
                                <div class="action-area">
                                    <button class="btn btn--base outline btn--sm actionBtn active" data-type="brand"
                                            type="button">@lang('Brand')</button>
                                    <button class="btn btn--base outline btn--sm actionBtn" data-type="influencer"
                                            type="button">@lang('Influencer')</button>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="d-flex flex-wrap justify-content-between">
                                        <div class="form--check">
                                            ...
                                            <label class="form-check-label" for="remember">@lang('Remember me')
                                            </label>
                                        </div>
    ...
    <script>
        (function($) {
            ...
            function changeAttribute() {
                let userType = sessionStorage.getItem("login_user_type") ?? 'influencer';
