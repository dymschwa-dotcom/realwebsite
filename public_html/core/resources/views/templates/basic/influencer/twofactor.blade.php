...
@section('content')
    <div class="container">
        <div class="row justify-content-center gy-4">
            ...
            @if (!auth()->guard('influencer')->user()->ts)
                <div class="col-12">
                    <div class="card custom--card">
                        <div class="card-header">
                            <h5 class="card-title m-0">@lang('Add Your Account')</h5>
                        </div>
            ...
            <div class="col-12">
                @if (auth()->guard('influencer')->user()->ts)
                    <div class="card custom--card">
                        <div class="card-header">
                            <h5 class="card-title m-0">@lang('Disable 2FA Security')</h5>
                        </div>
                ...
                @else
                    <div class="card custom--card">
                        <div class="card-header">
                            <h5 class="card-title m-0">@lang('Enable 2FA Security')</h5>
                        </div>
