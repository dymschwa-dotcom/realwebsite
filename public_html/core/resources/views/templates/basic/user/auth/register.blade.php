                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="account-form">
                                ...
                                <div class="row">
                                    ...
                                    @if (gs('agree'))
                                        ...
                                        <div class="form--check form-group">
                                            ...
                                            <label class="mx-2" for="agree">@lang('I agree with')</label>
                                            <span>
                            ...
                            <div class="have-account text-center mt-3">
                                <p class="have-account__text mb-0">@lang('Already Have An Account')? <a class="have-account__link text--base login-url" href="{{ route('user.login') }}">@lang('Login Now')</a>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn--base btn--sm login-url"
    ...
    <script>
        ...
        (function($) {
            $('.checkUser').on('focusout', function(e) {
                ...
                let userCheck = sessionStorage.getItem("register_user_type") ?? 'brand';
                let url;
            ...
            function changeAttribute() {
                let userType = sessionStorage.getItem("register_user_type") ?? 'brand';
