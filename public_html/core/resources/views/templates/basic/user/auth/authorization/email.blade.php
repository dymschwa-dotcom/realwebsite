                ...
                <div class="verification-code-wrapper">
                    <div class="verification-area">
                        <form class="submit-form" action="{{ route('user.verify.email') }}" method="POST">
                            ...
                            <p>
                                @lang('If you don\'t get any code'), <span class="countdown-wrapper">@lang('try again after') <span class="fw-bold" id="countdown">--</span> @lang('seconds')</span> <a class="try-again-link d-none" href="{{ route('user.send.verify.code', 'email') }}"> @lang('Try again')</a>
                            </p>
