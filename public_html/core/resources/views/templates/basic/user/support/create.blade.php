                ...
                <form action="{{ route('ticket.store') }}" class="disableSubmission" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="priority" class="form-select select2" data-minimum-results-for-search="-1" required>
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="mb-2"><small class="text--info text-small">@lang('Max 5 files can be uploaded | Maximum upload size is ' . convertToReadableSize(ini_get('upload_max_filesize')) . ' | Allowed File Extensions: .jpg, .jpeg, .png, .pdf, .doc, .docx')</small></p>
