...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $widget['total_influencer']             = Influencer::count();
        $widget['verified_influencer']          = Influencer::active()->count();
        $widget['email_unverified_influencer']  = Influencer::emailUnverified()->count();
        $widget['mobile_unverified_influencer'] = Influencer::mobileUnverified()->count();
        ...
        $widget['total_campaign']    = Campaign::count();
        $widget['pending_campaign']  = Campaign::pending()->count();
        $widget['approved_campaign'] = Campaign::approved()->count();
        $widget['rejected_campaign'] = Campaign::rejected()->count();
