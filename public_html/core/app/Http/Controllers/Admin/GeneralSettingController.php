...
class GeneralSettingController extends Controller {
    ...
    public function generalUpdate(Request $request) {
        $request->validate([
            ...
            'brand_register_bonus_amount'      => 'required|numeric|gte:0',
        ...
        $general->brand_register_bonus_amount      = $request->brand_register_bonus_amount;
    ...
    public function systemConfigurationSubmit(Request $request) {
        ...
        $general->influencer_registration          = $request->influencer_registration ? Status::ENABLE : Status::DISABLE;
        $general->agree                            = $request->agree ? Status::ENABLE : Status::DISABLE;
        $general->multi_language                   = $request->multi_language ? Status::ENABLE : Status::DISABLE;
        $general->campaign_approve                 = $request->campaign_approve ? Status::ENABLE : Status::DISABLE;
        $general->brand_register_commission        = $request->brand_register_commission ? Status::ENABLE : Status::DISABLE;
        $general->influencer_register_commission   = $request->influencer_register_commission ? Status::ENABLE : Status::DISABLE;
        $general->influencer_withdrawal_commission = $request->influencer_withdrawal_commission ? Status::ENABLE : Status::DISABLE;
        $general->campaign_charge                  = $request->campaign_charge ? Status::ENABLE : Status::DISABLE;
        $general->save();
