...
class SupportTicketController extends Controller
{
    ...
    {
        $pageTitle = 'Support Tickets';
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->where('influencer_id', '!=', 0)->orderBy('id', 'desc')->with('influencer')->paginate(getPaginate());
    ...
    {
        $pageTitle = 'Pending Tickets';
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->where('influencer_id', '!=', 0)->pending()->orderBy('id', 'desc')->with('influencer')->paginate(getPaginate());
        return view('admin.support.influencer_tickets', compact('items', 'pageTitle'));
    }
    ...
    {
        $pageTitle = 'Closed Tickets';
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->where('influencer_id', '!=', 0)->closed()->orderBy('id', 'desc')->with('influencer')->paginate(getPaginate());
        return view('admin.support.influencer_tickets', compact('items', 'pageTitle'));
    }
    ...
    {
        $pageTitle = 'Answered Tickets';
        $items = SupportTicket::searchable(['name', 'subject', 'ticket'])->where('influencer_id', '!=', 0)->orderBy('id', 'desc')->with('influencer')->answered()->paginate(getPaginate());
        return view('admin.support.influencer_tickets', compact('items', 'pageTitle'));
    }
}
