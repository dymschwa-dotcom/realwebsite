...
class WithdrawalController extends Controller {
    ...
    protected function withdrawalData($scope = null, $summary = false, $userId = null) {
        ...
        if ($userId) {
            $withdrawals = $withdrawals->where('influencer_id', $userId);
        }
    ...
    public function approve(Request $request) {
        ...
        if (gs('influencer_withdrawal_commission')) {
            ReferralCommission::levelCommission($withdraw->influencer, $withdraw->amount, 'influencer_withdrawal_commission', $withdraw->trx, 'influencer_id');
        }
