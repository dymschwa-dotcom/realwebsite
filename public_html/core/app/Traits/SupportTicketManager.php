...
trait SupportTicketManager
{
    ...
    public function supportTicket()
    {
        ...
        $layout = $this->layout;
        return view("Template::$this->userType" . '.support.index', compact('supports', 'pageTitle','layout'));
    }
    ...
    public function openSupportTicket()
    {
        ...
        $layout = $this->layout;
        return view("Template::$this->userType" . '.support.create', compact('pageTitle', 'user','layout'));
    }
